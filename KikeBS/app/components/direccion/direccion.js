...
var isInit = true,
    ...
    service = require('./direccion-service'),
    // additional requires

    viewModel = require('./direccion-view-model');

function onListViewItemTap(args) {
    var itemData = viewModel.get('listItems')[args.index];

    helpers.navigate({
        moduleName: 'components/direccion/itemDetails/itemDetails',
...
function onAddItemTap(args) {
    helpers.navigate({
        moduleName: 'components/direccion/addItemForm/addItemForm'
    });
}
