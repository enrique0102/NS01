...
var isInit = true,
    ...
    service = require('./seguimiento-service'),
    // additional requires

    viewModel = require('./seguimiento-view-model');

function onListViewItemTap(args) {
    var itemData = viewModel.get('listItems')[args.index];

    helpers.navigate({
        moduleName: 'components/seguimiento/itemDetails/itemDetails',
